...
RSpec.describe Solicitud, type: :model do
  before(:each) do
    @usuario_1 = Usuario.new(id: 1, email: Faker::Internet.email, nombre: Faker::Name.name,
                             imagen_perfil: Faker::Internet.url, direccion: Faker::Address.full_address, telefono: '912345678', password: 'abcdefg')
    @usuario_2 = Usuario.new(id: 1, email: Faker::Internet.email, nombre: Faker::Name.name,
                             imagen_perfil: Faker::Internet.url, direccion: Faker::Address.full_address, telefono: '912345678', password: 'abcdefg')
    @turno = Turno.new(id: 1, dia: 'Lunes', direccion_salida: Faker::Address.full_address, hora_salida: '12:00:00',
                       tipo: 'Ida', cupos: 4, campus: 'San Joaquín', created_at: nil, updated_at: nil, usuario: @usuario_1)
